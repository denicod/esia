...
class SignerCPDataHash extends AbstractSignerPKCS7 implements SignerInterface
{
    ...
    public function sign(string $message): string
    {
        ...
        $certlist = $certs->Find(CERTIFICATE_FIND_SUBJECT_NAME, $this->config->getClientCertSubject(), 0); // ищем сертификат, у которогое Subject = мнемонике нашей ИС
